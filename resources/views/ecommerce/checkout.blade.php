...
@section('title')
    <title>Checkout - Laravel Ecommerce</title>
@endsection
                            ...
                            <form class="row contact_form" action="{{ route ('front.store_checkout') }}" method="post" novalidate="novalidate">
                                @csrf
                                    ...
                                    <div class="col-md-12 form-group p_star">
                                        ...
                                        <input type="text" class="form-control" id="add1" name="customer_address" value="{{ auth()->guard('customer')->user()->address }}" required>
